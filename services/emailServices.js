...
const sendGiftEmail = async (userEmail, giftVarian) => {
    const mailOptions = {
        ...
        text: `Hello my princess, if you have opened this email, it means you have played the spinner wheel that I made, and what you got is: ${giftVarian}. I hope you like it, happy birthday darling 😘
        -Your bf: Azmi Yushari-`
    };
